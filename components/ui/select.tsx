...
/* eslint-disable react-hooks/immutability, react-hooks/refs, prefer-const */
...
const SelectTrigger = forwardRef<HTMLButtonElement, SelectTriggerProps>(
  (
    ...
    const label = selectedLabel ?? (value ? labelMap.current.get(value) ?? value : undefined);
        ...
        >
          ...
          >
            ...
            <AnimatePresence>
              {checkedRect && (
                <motion.div
                  className={`absolute ${shape.bg} bg-accent/60 dark:bg-accent/40 pointer-events-none`}
                  initial={false}
                  animate={{
                    top: checkedRect.top,
